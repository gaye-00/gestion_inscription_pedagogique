...
public class FormationService {
    ...
    // JDialog dialog = new JDialog(parent, "Étudiants inscrits à " +
    // formation.getNom(), true);
    ...
    // "Étudiants inscrits à : " + formation.getCode() + " - " + formation.getNom(),
    // JLabel.CENTER);
    ...
    // String[] columnNames = { "INE", "Prénom", "Nom", "Email", "Groupe" };
    // DefaultTableModel tableModel = new DefaultTableModel(columnNames, 0);

    // // Remplissage du tableau avec les étudiants
    // List<Etudiant> formationEtudiants =
    // etudiantService.getEtudiantsByFormation(formation);
    ...
    // etudiant.getNom(),
    // etudiant.getEmail(),
    // etudiant.getGroupe() != null ? etudiant.getGroupe().getNumero() : "Aucun"
    // });
    // }

    // // Création du tableau avec un meilleur rendu
    // JTable etudiantsTable = new JTable(tableModel);
    // etudiantsTable.setFont(new Font("Arial", Font.PLAIN, 14));
    // etudiantsTable.setRowHeight(25);
    // etudiantsTable.getTableHeader().setFont(new Font("Arial", Font.BOLD, 14));
    // etudiantsTable.getTableHeader().setBackground(new Color(200, 200, 200));
    ...
    // etudiantsTable.setDefaultRenderer(Object.class, new
    ...
    // titleLabel.setBorder(BorderFactory.createEmptyBorder(15, 10, 15, 10));
    // titleLabel.setBackground(new Color(240, 240, 240));
    // titleLabel.setOpaque(true); // Nécessaire pour voir la couleur de fond
    // dialog.add(titleLabel, BorderLayout.NORTH);
    ...
    // etudiantsTable.getTableHeader().setFont(new Font("Arial", Font.BOLD, 14));
    // etudiantsTable.getTableHeader().setBackground(new Color(200, 200, 200));
    // etudiantsTable.getTableHeader().setReorderingAllowed(false); // Désactiver le
    // réarrangement des colonnes
    // etudiantsTable.setFillsViewportHeight(true);

    // // Effet de surlignage au survol des lignes
    // etudiantsTable.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
    // etudiantsTable.setDefaultRenderer(Object.class, new
    // DefaultTableCellRenderer() {
    // @Override
    ...
    // hasFocus, row, column);
    // if (!isSelected) {
    // // Gestion de l'alternance de couleurs
    // c.setBackground(row % 2 == 0 ? new Color(240, 240, 240) : Color.WHITE);
    // }
    // return c;
    // }
    ...
    // // Ajout du tableau avec un JScrollPane pour le défilement
    // JScrollPane scrollPane = new JScrollPane(etudiantsTable);
    // scrollPane.setBorder(BorderFactory.createEmptyBorder(5, 10, 5, 10));
    // dialog.add(scrollPane, BorderLayout.CENTER);
    ...
    // JPanel buttonPanel = new JPanel();
    // buttonPanel.setBorder(BorderFactory.createEmptyBorder(10, 0, 15, 0));
    // buttonPanel.setLayout(new FlowLayout(FlowLayout.CENTER)); // Centrer le
    // bouton
    // buttonPanel.add(closeButton);
    // dialog.add(buttonPanel, BorderLayout.SOUTH);
    ...
    // JLabel titleLabel = new JLabel("Gestion des Étudiants de la formation : " +
    // formation.getNom(), JLabel.CENTER);
    ...
    // // Champ de recherche
    // JPanel searchPanel = new JPanel();
    // searchPanel.setLayout(new FlowLayout(FlowLayout.CENTER)); // Centrer le champ
    // de recherche
    // JTextField searchField = new JTextField(20);
    ...
    // headerPanel.add(Box.createVerticalStrut(10)); // Espacement vertical entre le
    ...
    // // etudiantsTable.setIntercellSpacing(new Dimension(10, 5));
    // // etudiantsTable.setShowGrid(false);
    // // etudiantsTable.setFillsViewportHeight(true);
    // etudiantsTable.setRowHeight(30);
    ...
    // TableRowSorter<>(etudiantsTableModel);
    // etudiantsTable.setRowSorter(sorter);
    ...
    // filterTable(etudiantsTableModel, searchField.getText(), formationEtudiants);
    // }
    ...
    // JScrollPane scrollPane = new JScrollPane(etudiantsTable);
    // scrollPane.setBorder(BorderFactory.createLineBorder(new Color(220, 220,
    // 220)));
    ...
    // // Style des boutons
    // // JButton addEtudiantButton = createStyledButton("Ajouter un étudiant", new
    // // Color(46, 139, 87));
    // // JButton modifyEtudiantButton = createStyledButton("Modifier étudiant", new
    // // Color(70, 130, 180));
    // // JButton deleteEtudiantButton = createStyledButton("Supprimer étudiant",
    // new
    // // Color(178, 34, 34));
