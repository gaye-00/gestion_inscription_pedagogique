...
public class MainFrame extends JFrame {
    ...
    // Méthode pour récupérer les responsables pédagogiques depuis la BD
    ...
    // Méthode pour sauvegarder une formation dans la BD
    ...
    private String[][] getStatisticsFromDatabase() {
        ...
        try {
            ...
            Long inscriptionCount = em.createQuery(
                    ...
                    .getSingleResult();
            statData[3][1] = inscriptionCount.toString();
        } catch (Exception e) {
    ...
    private void showEtudiantsList(Formation formation) {
        // Créer une fenêtre de dialogue
        JDialog dialog = new JDialog(this, "Étudiants inscrits à " + formation.getNom(), true);
        dialog.setSize(600, 400);
        dialog.setLocationRelativeTo(this);
        dialog.setLayout(new BorderLayout());
