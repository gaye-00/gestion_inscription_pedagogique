...
VALUES 
('Ngor', 'Fall', '2000-05-15', "INE001", 'MASCULIN', 'Dakar', 'e', false, SHA2('e', 256), 'ETUDIANT'),
...
('Tamba', 'Mbaye', '2004-03-30', null, 'FEMININ', 'Tamba', 'r', null, SHA2('r', 256), 'ResponsablePedagogique'),
...
INSERT INTO ue (code, nom, volumeHoraire, coefficient, credits, formation_id, enseignant_id, obligatoire)
VALUES ('INFO101','Algorithmique Avancée',60,1.5,6,9,1,true),
    ('INFO102','Bases de Données',45,1.0,4,9,2, true),
    ('INFO103','Programmation Web',30,1.0,4,9,2,false),
    ( 'INFO201', 'Intelligence Artificielle', 60, 1.5, 6, 9, 1, true),
    ('INFO202','Big Data',45,1.0,4,9,2,false );
