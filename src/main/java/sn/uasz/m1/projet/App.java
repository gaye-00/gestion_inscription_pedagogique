...
public class App {
    public static void main(String[] args) {
        ...
        // // Formation formation = new Formation(null, "Master Informatique",
        // Niveau.M1, null, null);
        ...
        // // Ajouter une UE
        // UE ue = new UE(null, "ALG001", "Algorithmes avancés", 6, 4.9, 4, "resp",
        // null, formation, true);
        // ueService.add(ue);
        ...
        // etudiantService.getAll().forEach(e -> System.out.println(e.getNom() + " " +
        // e.getPrenom()));
